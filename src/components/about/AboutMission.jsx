...
const cards = [
  {
    tag: "THE NAME",
    icon: "🌿",
    title: "Physis — 그리스어 “자연”",
    desc: "사명은 그리스어로 '자연'을 뜻합니다. 최대한 자연 친화적인 환경을 유지하며 사업하겠다는 철학을 담았습니다.",
  },
  {
    tag: "THE SYMBOL",
    icon: "🧊",
    title: "빙산 — 보이지 않는 깊이",
    desc: "로고 심볼은 빙산을 형상화했습니다. 보이는 것보다 보이지 않는 것에 더 많은 가치가 있다는 의미를 담았습니다.",
  },
];
  ...
  return (
    <section className="about-mission">
      <div className="about-mission__inner">
        ...
        <h2 className="about-mission__title">Physis가 추구하는 것</h2>
