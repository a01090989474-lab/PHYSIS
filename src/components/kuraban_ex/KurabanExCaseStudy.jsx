    ...
    <section className="kex-case">
      <div className="kex-case__inner">
        <div className="kex-case__head">
          <div>
            <p className="kex-case__label">창고형 쿠라반 활용 사례</p>
        ...
        <div className="kex-case__body">
          <div className="kex-case__company">
            <div className="kex-case__company-media">
              <img
                src="/images/kurabanEx/kurabanEx_01.png"
                alt="호리우치 상사 매장 · 숙성육 사진"
              />
            </div>
            <p className="kex-case__company-name">호리우치 상사</p>
          ...
          <div className="kex-case__quote">
            ...
            <p className="kex-case__quote-text">
              창고형 Kuraban을 사용하면 고기의 맛과 향이 분명히 증가합니다.
              소고기는 육질이 놀라울 정도로 부드러워지고, 돼지고기는 맛이 더욱
              강해집니다. 고객님들의 재방문률이 높아졌고 만족도가 큽니다.
            </p>
        ...
        <div className="kex-case__highlights">
          ...
          <div className="kex-case__highlight">
            ...
            <p className="kex-case__highlight-desc">
              손실 없이 부가가치만 더하는 구조라 미들층 소비자를 위한 합리적
              가격대를 만들 수 있었습니다.
            </p>
          </div>
          <div className="kex-case__highlight">
            ...
            <p className="kex-case__highlight-desc">
              “생명을 낭비하지 않는다”는 가치가 전해져, 농협·생산자와의 거래
              신뢰 관계가 깊어졌습니다.
            </p>
          </div>
        </div>
